...
void main() {
  group('Profile Feature Widget Tests', () {
    testWidgets('ProfilePage renders user profile, menu items, and logout button', (tester) async {
    ...
    testWidgets('BankSettingsPage renders live card preview and bank setup form', (tester) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 2.0;
      addTearDown(() => tester.view.resetPhysicalSize());
      ...
      expect(find.text('Tên chủ tài khoản (In hoa không dấu)'), findsOneWidget);
      expect(find.text('Lưu tài khoản VietQR'), findsOneWidget);
    });

    testWidgets('EditProfilePage renders personal information form', (tester) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 2.0;
      addTearDown(() => tester.view.resetPhysicalSize());
    ...
    testWidgets('ChangePasswordPage renders password form and security checklist', (tester) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 2.0;
      addTearDown(() => tester.view.resetPhysicalSize());
