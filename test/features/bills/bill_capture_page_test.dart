...
void main() {
  ...
  group('BillCapturePage Widget Tests', () {
    testWidgets('renders camera overlay, close button, and manual entry button when 0 photos', (tester) async {
      await tester.pumpWidget(
        const ProviderScope(
          child: MaterialApp(
            home: BillCapturePage(),
          ),
        ),
      );
      await tester.pump();
    ...
    testWidgets('tapping shutter adds photo and changes button to Chia tiền (1)', (tester) async {
      await tester.pumpWidget(
        const ProviderScope(
          child: MaterialApp(
            home: BillCapturePage(),
    ...
    testWidgets('tapping photo opens PhotoDetailDialog with crop action', (tester) async {
